      ...
      <Container maxWidth="md" sx={{ my: 4 }}>
        ...
        <Box sx={{ padding: 1 }}>
          ...
          <Typography>
            ...
            on this Website, under these Terms,{" "}
            <Link href="/">
        ...
        <Box sx={{ padding: 1 }}>
          ...
          <Box component="ul" sx={{ ml: 2 }}>
            <li className="!list-decimal !text-base !font-normal">
        ...
        <Box sx={{ padding: 1 }}>
          ...
          <Typography>
            <Typography>
              ...
              a non-exclusive, worldwide, irrevocable, royalty-free,
              sublicensable license to use, reproduce, adapt, publish, translate
              and distribute it in any and all media. <br />
              <br />
        ...
        <Box sx={{ padding: 1 }}>
          ...
          <Typography>
            ...
            shall be permitted to assign, transfer, and subcontract its rights
            and/or obligations under these Terms without any notification or
